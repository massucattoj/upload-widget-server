...
describe('export uploads', () => {
  /**
   * ensure that the csv content was generated correctly
   */
  it('should be able to export uploads', async () => {
    ...
    const generatedCSVStream = uploadStub.mock.calls[0][0].contentStream // [0][0] First time that the function was called and first parameter
